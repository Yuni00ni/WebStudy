/*
     ...
     => 내가 만약 HTML문서를 무언가 바꿔주고 싶다? -> 무조건 document로 가야함!

     ex) <h1 id="h1Tag">안녕하세요.</h1> -> 쪼개기
     h1(태그), id(속성), h1Tag(속성값), 안녕하세요.(contents)
     => 사용이유? : 요소를 효과적으로 제어하기 위해서
...
// class나 TagName이나 Name같은 경우에는 한 페이지에 여러 개가 있을 가능성이 존재
// 그래서 하나만 가지고 오지 않음
...
console.log(pTagClass[1]);

// HTMLCollection 이란? 유사배열 -> 인덱스 번호를 통해서 접근
