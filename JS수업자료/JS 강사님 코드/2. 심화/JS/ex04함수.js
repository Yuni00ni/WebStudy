...
//      - 중복되는 코드를 최소화하고 재사용성 O
//      - 함수를 정의할 때는 funciton 키워드를 사용
...
function makeAnyJuice(fruit, size){
    console.log('===============');
    console.log('주스 제조 시작!');
    console.log(fruit + '를 착즙한다.');
    console.log(fruit + ' 주스가 완성되었다!');
    console.log('===============');

    if(size == 'tall'){
        console.log('3500원입니다.');
    }else if(size == 'venti'){
...
console.log(makeRandom(),makeRandom(),makeRandom());
...
// => 함수도 그 안에 넣어버리자! 재선언, 재할당 방지하기 위해 const
